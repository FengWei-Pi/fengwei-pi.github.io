...
const curves = [
  [
    [[0.5, 0], [0.433,0.233], [0.223,0.47], [0.3,0.7]],
    [[0.3, 0.7], [0.343, 0.83], [0.672, 0.706], [0.69,0.57]],
    [[0.69, 0.57], [0.707, 0.441], [0.466, 0.371], [0.34, 0.4]],
    [[0.34, 0.4], [0.186,0.436], [0.113, 0.62], [0, 0.73]]
  ],
  [
    [[0.5, 0], [0.567, 0.2], [0.778, 0.404], [0.7, 0.6]],
    [[0.7, 0.6], [0.649, 0.728], [0.436, 0.48], [0.3, 0.5]],
    [[0.3, 0.5], [0.181, 0.517], [0.1, 0.633], [0, 0.7]]
  ],
  [
    [[0.5, 0], [0.547,0.16], [0.764, 0.369], [0.64, 0.48]],
    [[0.64,0.48], [0.518,0.588], [0.354,0.214], [0.2,0.267]],
    [[0.2,0.267], [0.05,0.319], [0.067,0.556], [0,0.7]]
  ],
  [
    [[0.75, 0], [0.657, 0.0933], [0.43, 0.12], [0.37, 0.28]],
    [[0.37, 0.28], [0.322, 0.407], [0.639, 0.529], [0.56, 0.64]],
    [[0.56,0.64], [0.447,0.798], [0.187, 0.747], [0,0.8]]
  ],
  [
    [[0.5, 0], [0.422,0.533], [0.5,0.533], [0,0.7]]
  ],
  [
    [[0.5, 0], [0.42, 0.133], [0.321, 0.257], [0.26, 0.4]],
    [[0.26, 0.4], [0.113, 0.745], [0.268, 0.912], [0, 0.8]]
  ],
  [
  ...
  [
    [[0.3, 0], [0.48, 0.113], [0.729, 0.159], [0.84, 0.34]],
    [[0.84, 0.34], [0.913, 0.459], [0.882, 0.683], [0.76, 0.75]],
    [[0.76, 0.75], [0.537, 0.872], [0.253, 0.783], [0, 0.8]]
  ],
  [
    [[0.5, 0], [0.793, 0.557], [0.627, 0.412], [0, 0.8]]
  ],
  [
    [[0.5, 0], [0.29, 0.27], [0.26, 0.44], [0, 0.6]]
  ],
  [
    [[0.3, 0], [0.2, 0.1], [0.07, 0.285], [0, 0.6]]
  ],
  [
    [[0.4, 0], [0.44, 0.047], [0.536, 0.081], [0.52, 0.14]],
    [[0.52, 0.14], [0.5, 0.212], [0.373, 0.199], [0.33, 0.26]],
    [[0.33, 0.26], [0.307, 0.293], [0.373, 0.347], [0.35, 0.38]],
    [[0.35, 0.38], [0.307, 0.441], [0.202, 0.437], [0.16, 0.5]],
    [[0.16, 0.5], [0.137, 0.534], [0.216, 0.588], [0.19, 0.62]],
    [[0.19, 0.62], [0.147, 0.674], [0.063, 0.673], [0,0.7]]
  ]
];
